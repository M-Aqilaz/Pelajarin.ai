        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div class="glass-panel p-4 rounded-2xl border border-white/5">
                    <p class="text-xs text-gray-400 mb-1 font-medium uppercase">Total Dokumen</p>
                    <p class="text-2xl font-bold font-outfit text-white">12</p>
                </div>
                <div class="glass-panel p-4 rounded-2xl border border-white/5">
                    <p class="text-xs text-gray-400 mb-1 font-medium uppercase">Flashcards</p>
                    <p class="text-2xl font-bold font-outfit text-white">48</p>
                </div>
                <div class="glass-panel p-4 rounded-2xl border border-white/5">
                    <p class="text-xs text-gray-400 mb-1 font-medium uppercase">Kuis Selesai</p>
                    <p class="text-2xl font-bold font-outfit text-white">5</p>
                </div>
                <div class="glass-panel p-4 rounded-2xl border border-white/5 bg-gradient-to-br from-purple-900/40 to-transparent">
                    <p class="text-xs text-purple-300 mb-1 font-medium uppercase">Streak Belajar</p>
                    <div class="flex items-center gap-2">
                        <p class="text-2xl font-bold font-outfit text-white">7 Hari</p>
