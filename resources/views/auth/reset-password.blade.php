...
<head>
    ...
    <title>Reset Password - Nalarin.ai</title>
        ...
        <section class="grid w-full max-w-5xl overflow-hidden rounded-[2rem] border border-sky-200 bg-white/88 shadow-[0_24px_70px_rgba(14,116,144,0.18)] backdrop-blur-xl lg:grid-cols-[0.95fr_1.05fr]">
            <aside class="relative hidden min-h-[620px] overflow-hidden bg-gradient-to-br from-sky-100 via-white to-cyan-100 p-8 lg:block">
                ...
                <div class="mt-8 max-w-sm">
                    <p class="text-xs font-extrabold uppercase tracking-[0.24em] text-sky-700">New Password</p>
                    <h1 class="mt-4 font-outfit text-4xl font-extrabold leading-tight text-slate-950">Buat password baru yang aman.</h1>
                    <p class="mt-5 text-base leading-7 text-slate-700">Setelah password berhasil diganti, kamu bisa login lagi dan lanjut belajar dari dashboard.</p>
                </div>
            </aside>
            ...
            <section class="p-6 sm:p-8 lg:p-10">
                ...
                <div>
                    <p class="text-xs font-extrabold uppercase tracking-[0.24em] text-sky-700">Reset Password</p>
                    <h2 class="mt-3 font-outfit text-3xl font-extrabold text-slate-950">Atur ulang password</h2>
                    <p class="mt-2 text-sm leading-6 text-slate-600">Gunakan password baru yang kuat dan mudah kamu ingat.</p>
                </div>
