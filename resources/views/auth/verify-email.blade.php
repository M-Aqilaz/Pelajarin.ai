...
<body class="font-inter antialiased bg-gray-950 text-gray-100 min-h-screen flex items-center justify-center relative overflow-hidden">
    ...
    <div class="w-full max-w-md px-6 z-10 animate-float">
        ...
        <div class="glass-card rounded-3xl p-8 shadow-2xl relative overflow-hidden text-center">
            ...
            <div class="space-y-6 relative z-10">
                ...
                <form method="POST" action="{{ route('logout') }}">
                    @csrf
                    <button type="submit" class="text-sm text-gray-400 hover:text-white transition-colors font-medium underline">
                        Keluar (Log Out)
                    </button>
                </form>
            </div>
