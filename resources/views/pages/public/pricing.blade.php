    ...
    <body class="bg-gray-950 text-white font-inter min-h-screen">
        ...
        <div class="max-w-6xl mx-auto px-4 py-16">
            ...
            <div class="text-center mt-10">
                <h1 class="font-outfit text-5xl font-bold">Harga Produk Belajar AI</h1>
                <p class="text-gray-400 mt-4 max-w-2xl mx-auto">Struktur awal paket gratis dan premium untuk Nalarin.ai dengan kombinasi pembelajaran AI dan fitur sosial.</p>
            </div>
            <div class="grid md:grid-cols-2 gap-6 mt-14">
                <section class="rounded-[2rem] border border-white/10 bg-white/5 p-8">
                    <p class="text-xs uppercase tracking-[0.2em] text-gray-400">Gratis</p>
                    <h2 class="font-outfit text-3xl font-bold mt-3">Rp0</h2>
                    <p class="text-sm text-gray-400 mt-3">Untuk validasi produk dan orientasi awal.</p>
                    <ul class="space-y-3 mt-8 text-sm text-gray-200">
                        <li>Unggah materi dan ringkasan dasar</li>
                        <li>Kartu belajar dan kuis otomatis</li>
                        <li>Maksimal 2 ruang dibuat</li>
                        <li>Kuota pencocokan belajar terbatas</li>
                    </ul>
                ...
                <section class="rounded-[2rem] border border-purple-500/30 bg-gradient-to-br from-purple-600/20 to-blue-600/10 p-8">
                    ...
                    <p class="text-sm text-gray-300 mt-3">Untuk bisnis edukasi, komunitas belajar, dan retensi belajar sosial.</p>
                    <ul class="space-y-3 mt-8 text-sm text-gray-100">
                        <li>Ruang kelas lebih banyak</li>
                        <li>Pencocokan belajar tanpa batas</li>
                        <li>Prioritas fitur sosial</li>
                        <li>Penawaran lanjutan yang siap dipasang ke alur penjualan</li>
                    </ul>
                    <a href="{{ route('register') }}" class="mt-8 inline-block rounded-xl bg-purple-500 px-5 py-3 font-semibold">Tertarik Meningkatkan Paket</a>
                </section>
            </div>
        </div>
    </body>
